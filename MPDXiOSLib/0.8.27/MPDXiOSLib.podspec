Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
    ...
    'MPDXiOSLib_XCStrings' => ['Sources/MPDXiOSLib/Resources/XCStrings/Localizable.xcstrings'],
  ...
  s.dependency 'FirebaseCore', '10.29.0'
  s.dependency 'FirebaseCrashlytics', '10.29.0'
  s.dependency 'FirebasePerformance', '10.29.0'
  
  s.dependency 'GoogleTagManager', '~> 7.4.6'

  s.dependency 'Alamofire', '5.9.1'
  s.dependency 'PromiseKit', '8.1.2'
  
  s.dependency 'LocalizationServices', '~> 0.3.0'
  s.dependency 'MpdxApi', '~> 1.2.4'
  s.dependency 'RequestOperation', '~> 1.10.3'
  s.dependency 'OktaAuthentication', '~> 1.4.3'
  s.dependency 'OAuth', '~> 1.2.7'
end
